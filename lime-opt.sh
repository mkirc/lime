...
# ARG_OPTIONAL_SINGLE([nthreads],[p],[Use N threads],[1])
...
{
	local first_option all_short_options='fsdnphv'
	first_option="${1:0:1}"
...
print_help()
{
    ...
    printf '\t%s\t%s\n' "-n, --ncurses:" "Compile with ncurses support (for noninteractive use)"
